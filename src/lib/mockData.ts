...
export const mockSales: Sale[] = [
  ...generateSalesData(),
  // Last 24 hours sales (today) - High-value sales for ~30k revenue - October 28, 2025
  {
    id: "24h-1",
    invoiceNumber: "INV-2025-24001",
    customerId: "1",
    customerName: "Saman Perera",
    items: [{ product: mockProducts[2], quantity: 2, discount: 500 }],
    subtotal: 5200 * 2,
    discount: 500,
    tax: Math.floor((5200 * 2 - 500) * 0.18),
    total: 5200 * 2 - 500 + Math.floor((5200 * 2 - 500) * 0.18),
  ...
  {
    id: "24h-2",
    invoiceNumber: "INV-2025-24002",
    customerId: "2",
    customerName: "Nimal Jayasinha",
    items: [{ product: mockProducts[2], quantity: 1, discount: 0 }],
    subtotal: 5200,
    discount: 0,
    tax: Math.floor(5200 * 0.18),
    total: 5200 + Math.floor(5200 * 0.18),
  ...
  {
    id: "24h-3",
    invoiceNumber: "INV-2025-24003",
    customerId: "3",
    customerName: "Kamala Kumari",
    items: [{ product: mockProducts[1], quantity: 5, discount: 200 }],
    subtotal: 450 * 5,
    discount: 200,
    tax: Math.floor((450 * 5 - 200) * 0.18),
    total: 450 * 5 - 200 + Math.floor((450 * 5 - 200) * 0.18),
    paymentMode: "cash" as any,
    cashierId: "3",
    cashierName: "Dilini Cashier",
  ...
  {
    id: "24h-4",
    invoiceNumber: "INV-2025-24004",
    customerId: "4",
    customerName: "Raj Kumar",
    items: [{ product: mockProducts[0], quantity: 10, discount: 300 }],
    subtotal: 250 * 10,
    discount: 300,
    tax: Math.floor((250 * 10 - 300) * 0.18),
    total: 250 * 10 - 300 + Math.floor((250 * 10 - 300) * 0.18),
  ...
  {
    id: "24h-5",
    invoiceNumber: "INV-2025-24005",
    customerId: "5",
    customerName: "Anjali Singh",
    items: [{ product: mockProducts[2], quantity: 1, discount: 200 }],
    subtotal: 5200,
    discount: 200,
    tax: Math.floor((5200 - 200) * 0.18),
    total: 5200 - 200 + Math.floor((5200 - 200) * 0.18),
    paymentMode: "card" as any,
    cashierId: "3",
    cashierName: "Dilini Cashier",
  ...
  {
    id: "24h-6",
    invoiceNumber: "INV-2025-24006",
    customerId: "6",
    customerName: "Priya Sharma",
    items: [{ product: mockProducts[1], quantity: 3, discount: 100 }],
    subtotal: 450 * 3,
    discount: 100,
    tax: Math.floor((450 * 3 - 100) * 0.18),
    total: 450 * 3 - 100 + Math.floor((450 * 3 - 100) * 0.18),
    paymentMode: "cash" as any,
    cashierId: "3",
    cashierName: "Dilini Cashier",
  ...
  {
    id: "24h-7",
    invoiceNumber: "INV-2025-24007",
    customerId: "1",
    customerName: "Saman Perera",
    items: [{ product: mockProducts[0], quantity: 8, discount: 200 }],
    subtotal: 250 * 8,
    discount: 200,
    tax: Math.floor((250 * 8 - 200) * 0.18),
    total: 250 * 8 - 200 + Math.floor((250 * 8 - 200) * 0.18),
    paymentMode: "card" as any,
    cashierId: "3",
    cashierName: "Dilini Cashier",
  ...
  {
    id: "24h-8",
    invoiceNumber: "INV-2025-24008",
    customerId: "7",
    customerName: "Vikram Desai",
    items: [{ product: mockProducts[1], quantity: 4, discount: 150 }],
    subtotal: 450 * 4,
    discount: 150,
    tax: Math.floor((450 * 4 - 150) * 0.18),
    total: 450 * 4 - 150 + Math.floor((450 * 4 - 150) * 0.18),
    paymentMode: "cash" as any,
    cashierId: "3",
    cashierName: "Dilini Cashier",
...
export const mockExpenses: Expense[] = [
  // October 28, 2025 - Today's expenses (minimal for today)
  {
    id: "exp-oct-28-1",
    date: new Date(2025, 9, 28, 9, 0),
    category: "Utilities",
    vendor: "Dialog Axiata",
    description: "Daily internet/phone service fee",
    paymentMethod: "Card",
    amount: 200,
    paidBy: "Admin User",
  ...
  },
  {
    ...
    category: "Supplies",
    vendor: "Office Mart",
    description: "Daily supplies - tape, stationery",
    paymentMethod: "Cash",
    amount: 300,
  ...
  },
  {
    ...
    description: "October 2025 employee salaries (3 staff)",
    paymentMethod: "Bank Transfer",
    amount: 45000,
    paidBy: "Admin User",
  ...
  },
  {
    ...
    description: "Air conditioning system servicing",
    paymentMethod: "Card",
    amount: 5000,
  ...
  },
  {
    ...
    description: "Shopping bags and packing materials",
    paymentMethod: "Cash",
    amount: 2000,
    paidBy: "Dilini Cashier",
