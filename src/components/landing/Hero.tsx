      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center space-y-6">
          ...
          <p className="text-lg sm:text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
            Quality tools and materials for your projects. We've been helping builders, 
            contractors, and DIY enthusiasts get the job done right for years.
          </p>
          ...
          <div className="grid grid-cols-3 gap-4 max-w-2xl mx-auto pt-8 text-center">
            ...
            <div>
              <div className="text-2xl font-bold text-gray-900 dark:text-white">Trusted</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">By Many</div>
            </div>
          </div>
        </div>
      </div>
